...
model = dict(
    ...
    train_cfg=dict(
        ...
        debug=False,
    # MY CODE: 
    # The IoU sampler is used to sample positive and negative anchors
    # for training. It samples positive anchors with IoU greater than
    # pos_iou_thr and negative anchors with IoU less than neg_iou_thr.
    # The sampled anchors will be used to compute the classification
    # and regression loss.
    sampler={
