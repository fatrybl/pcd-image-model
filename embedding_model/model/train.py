...
class LidarClip(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        with torch.no_grad():
            ...
            image_features = self.clip.encode_image(image).float() # cast to float32
...
def train(
    ...
    lidar_encoder = LidarEncoderSST(cfg_path, clip_embed_dim)
    ...
    wandb_logger = WandbLogger(
        ...
        entity="mark_mark-skolkovo-institute-of-science-and-technology",
        name=name,
        resume=wand_resume,
        id=wandb_id,
...
def parse_args():
    ...
    parser.add_argument("--config-path", default=None, help="Path to the SST encoder configuration file")
